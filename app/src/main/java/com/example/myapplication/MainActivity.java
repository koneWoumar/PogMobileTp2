...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //
        //button de lancement de l'activity
        Button btngotoq_5_6 = (Button) findViewById(R.id.bntgotoq5_6);
        btngotoq_5_6.setOnClickListener(view -> {
            Intent question_5_6_ActivityIntent = new Intent(MainActivity.this, MainActivity2_question5.class);
            startActivity(question_5_6_ActivityIntent);
        });
        //
        //button de lancement de l'activity
        Button btngotoq_7 = (Button) findViewById(R.id.bntgotoq7);
        ...
        Button stop = (Button) findViewById(R.id.bntexit);
